...
public class AccountsDAO {
	...
	public AccountsVO getInfo(int accounts_num) {
		return (AccountsVO) this.sqlSession.selectOne("com.mentotee.mybatis.AccountsMapper.getInfo1",
				Integer.valueOf(accounts_num));
	}
	...
	public int updateCoin(AccountsVO vo) {
		return this.sqlSession.update(NAMESPACE + ".updateCoin", vo);
	}
}
